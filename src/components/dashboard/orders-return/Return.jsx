...
const Return = ({setActive}) => {
     return (
          <div>
               <div>
                    <h1 className='secondary'> Check the progress of your returns, reschedule collection and print your return documents</h1>
                    ...
                    <div className=' flex gap-3 justify-center items-center text-center py-16'>
                         <div className=' flex items-center gap-7 flex-col'>
                              ...
                              <div>
                                   ...
                                   <p className='secondary'>You can start a return request from the order tracker.</p>
                              </div>
                              <div>
